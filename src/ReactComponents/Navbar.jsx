...
function Navbar(props) {
  ...
  const redThemeHandler = () => {
    document.body.style.background = '#300307'
  ...
  const greenThemeHandler = () => {
    document.body.style.background = '#044041'
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="container d-flex flex-row-reverse text-end">
            <div className="d-flex justify-content-evenly align-items-center text-light gap-3">
              {/* Light mode */}
              {props.mode === 'dark' ? <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-brightness-high-fill" viewBox="0 0 16 16">
              ...
              </svg> : <span style={{fontSize: '1.5rem'}}>&#127774;</span>}
              ...
              {props.mode === 'dark' ? <span style={{fontSize: '1.5rem'}}>&#127770;</span> : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-moon-stars-fill" viewBox="0 0 16 16">
