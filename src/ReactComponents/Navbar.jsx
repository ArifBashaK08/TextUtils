      ...
      <div className="container-fluid justify-content-between">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="container d-flex flex-row-reverse text-end">
            ...
            <div className={`${props.mode === 'dark' ? 'd-flex' : 'd-none'} mx-5 gap-3`}>
              <button className="btn btn-danger rounded-circle" onClick={redThemeHandler}></button>
              <button className="btn btn-primary rounded-circle" onClick={blueThemeHandler}></button>
              <button className="btn btn-success rounded-circle" onClick={greenThemeHandler}></button>
            </div>
          </div>
        </div>
      </div>
